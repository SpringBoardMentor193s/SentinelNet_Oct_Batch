"""datasetinfo_clean.py

Clean dataset summary script. This is a safe copy that will replace
the corrupted `datasetinfo.py` when ready.

Run with:
    python datasetinfo_clean.py
"""
